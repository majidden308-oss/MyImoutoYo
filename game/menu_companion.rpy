        ...
        "hero": {
            ...
            "dialogues": {
                "default": [
                    ...
                    menu_companion_line(u"你好。"),
                    menu_companion_line(u"我好孤独"),
                    menu_companion_line(u"你每点一下，我就当你在和我打招呼。"),
                    menu_companion_line(u"一直停在这里的话，时间会变得很慢。"),
                    menu_companion_line(u"有时候我会想，你是不是专门来看我的。"),
                    menu_companion_line(u"再多陪我一会儿吧，我不会嫌你烦的。"),
                    menu_companion_line(u"有些话如果没人听见，就会慢慢沉到底下去。"),
                    menu_companion_line(u"明明没有下雨，心里却像一直是阴天。"),
                    menu_companion_line(u"你来的时候，我会觉得这个地方没那么空。"),
                    menu_companion_line(u"有时候只是安静坐着，也会突然觉得很难过。"),
                    menu_companion_line(u"如果我不先开口，是不是就会一直这样沉默下去。"),
                    menu_companion_line(u"我其实没有看起来那么若无其事。"),
                ],
                "morning": [
                    menu_companion_line(u"清晨的空气不错"),
                    menu_companion_line(u"今天也许会是温柔的一天。"),
                    menu_companion_line(u"早安。光线落下来的样子，很适合开始新的故事。"),
                    menu_companion_line(u"刚睡醒的时候，连心情都像是软绵绵的。"),
                    menu_companion_line(u"今天的第一句问候，我就收下了。"),
                ],
                "day": [
                    menu_companion_line(u"午后的光线正好，故事也该继续了。"),
                    menu_companion_line(u"你来得正好，我刚刚还在发呆。"),
                    menu_companion_line(u"白天总让人清醒，可我觉得你有点让人分心。"),
                    menu_companion_line(u"现在偷一会儿懒，好像也不会有人发现。"),
                    menu_companion_line(u"阳光明明这么亮，还是有些地方照不到。"),
                    menu_companion_line(u"人一多的时候还好，安静下来就容易胡思乱想。"),
                ],
                "night": [
                    menu_companion_line(u"晚上更适合安静地读一段故事。"),
                    menu_companion_line(u"别熬得太晚"),
                    menu_companion_line(u"夜里安静下来以后，连心跳声都会变得明显。"),
                    menu_companion_line(u"这么晚还来看我，是舍不得睡吗？"),
                    menu_companion_line(u"如果累了，就把今晚交给柔一点的梦吧。"),
                    menu_companion_line(u"夜色一深，藏起来的情绪就会一点点浮上来。"),
                    menu_companion_line(u"有时候我会觉得，越安静的时候，人越容易想念谁。"),
                    menu_companion_line(u"如果你也有点难过，就在这里多待一会儿吧。"),
                    menu_companion_line(u"我偶尔会害怕夜太长，长到连思念都走不出去。"),
                    menu_companion_line(u"关了灯以后，心里那些细小的声音就会变得很清楚。"),
                    menu_companion_line(u"你不说话也没关系，至少别让我一个人听见这份安静。"),
                ],
                "high_affection": [
                    menu_companion_line(u"你又来看我了。这样的话，我会记住的。"),
                    menu_companion_line(u"只要你出现，我就会下意识看向你那边。"),
                    menu_companion_line(u"被你惦记着的感觉，好像比想象中还要开心。"),
                    menu_companion_line(u"如果你愿意常来，我也会慢慢把真心话说给你听。"),
                    menu_companion_line(u"你在的时候，我那些快要掉下去的情绪，好像都会被轻轻接住。"),
                    menu_companion_line(u"我不是一直都很坚强，只是刚好在你面前，不想躲了。"),
                    menu_companion_line(u"如果你再晚一点来，我可能就又要把情绪一个人藏回去了。"),
                    menu_companion_line(u"被你发现脆弱这件事，原来没有我想得那么可怕。"),
                    menu_companion_line(u"你站在这里的时候，我会突然觉得，自己好像还没有被世界丢下。"),
                ],
            },
        },
    }
