...
define config.name = _("my imouto yo")
...
## 当前仓库未包含主菜单音乐资源，先关闭自动播放，避免启动时报缺失文件。
...
## 控制是否默认显示转场。2 表示显示全部转场，0 表示关闭转场。
...
define config.save_directory = "myimoutoyo-1773547251"
