...
## ====【修改】颜色主题优化 ====
define gui.accent_color = '#39C5BB'
...
## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#7A7A7A'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，
## 会处于选中状态。
define gui.selected_color = '#39C5BB'
...
define gui.hover_muted_color = '#7BE2D8'
...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/NotoSerifCJKsc-Regular.otf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/LXGWWenKai-Regular.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/NotoSansCJKsc-Regular.otf"
...
define gui.quick_button_text_font = gui.name_text_font
...
define gui.choice_button_text_hover_color = "#7A7A7A"
